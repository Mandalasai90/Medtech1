...
function Cart({ topMargin, cartItems, setCartItems }) {
  ...
  const total = cartItems.reduce((acc, item, index) => acc + calculateSubtotal(item.price, quantities[index]), 0);
  ...
  return (
    <div className="w-full h-full flex flex-col justify-center  font-sans bg-gray-200 p-8" style={{ marginTop: `${topMargin}px` }}>
      <p className=" lg:text-2xl lg:mb-2 text-black flex ">PharmaTrade {`>`}  Cart</p>
      ...
      {cartItems.length > 0 ? (
          ...
          <div className="flex w-84 pt-10">
              ...
              <table className="min-w-full">
                <thead>
                  <tr>
                    ...
                    <th scope="col" className="px-5 py-3 text-[22px] text-left font-medium text-blue-950 tracking-wider">Image</th>
                    <th scope="col" className="px-5 py-3 text-[22px] text-left font-medium text-blue-950 tracking-wider">Product Name</th>
                    <th scope="col" className="px-5 py-3 text-[22px] text-left font-medium text-blue-950 tracking-wider">Price</th>
                    <th scope="col" className="px-5 py-3 text-[22px] text-left font-medium text-blue-950 tracking-wider">Quantity</th>
                    <th scope="col" className="px-5 py-3 text-[22px] text-left font-medium text-blue-950 tracking-wider">Subtotal</th>
                  </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200 border-2 rounded-lg">
                  {cartItems.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td className="px-5 py-4 whitespace-nowrap">Vitamin C(1000IU) Cap X</td>
            ...
            <div className="lg:ml-10">
              <table>
                <thead>
                  <tr>
                    <th className="px-5 py-3 text-center font-medium text-blue-950 text-[22px]">Cart Totals</th>
                  </tr>
                </thead>
                <tbody className="border rounded-lg">
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-center font-medium">Subtotal</td>
                    <td className="px-12 py-4 whitespace-nowrap text-center">$ amount</td>
                  </tr>
                  <tr>
        ...
        <div className="flex flex-col items-center justify-center mt-20">
          <h2 className="text-2xl font-semibold text-gray-700">Your cart is currently empty.</h2>
          <Link
            to="/products"
